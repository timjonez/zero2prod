...
impl std::fmt::Display for SubscribeError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            SubscribeError::InsertSubscriberError(_) => write!(f, "Failed to insert new subscriber into the database"),
            SubscribeError::TransactionCommitError(_) => write!(f, "Failed to commit SQL transaction to store new subscriber"),
        }
    }
}
